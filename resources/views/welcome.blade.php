...
<div class="container pt-5">
    <div class="row">
      ...
      <form class="col-md-4 order-md-1 col-lg-3 sidebar-filter">
        <h3 class="mt-0 mb-5">Wyświetlam <span class="text-primary">{{count($products)}}</span> produktów</h3>
        ...
        <div class="price-filter-control">
          <input type="number" class="form-control w-50 pull-left mb-2" placeholder="50" name="filter[price-min]" id="price-min-control">
          <input type="number" class="form-control w-50 pull-right" placeholder="150" name="filter[price-max]" id="price-max-control">
        </div>
